...
#define png_error(png_ptr, error_message) png_err(png_ptr)
#define png_chunk_error(png_ptr, error_message) png_err(png_ptr)
#endif
...
extern PNG_EXPORT(void,png_chunk_warning) PNGARG((png_structp png_ptr,
   png_const_charp warning_message));
#else
#define png_warning(png_ptr, warning_message)
#define png_chunk_warning(png_ptr, warning_message)
#endif
