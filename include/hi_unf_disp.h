...
/**
   ...
   \param[in] enDisp   DISP channel ID.CNcomment:DISPͨ���� CNend
   \param[in] u32Width  virtual screen width, the range is [480, 4096].CNcomment:������Ļ��ȣ�ȡֵ��ΧΪ[480, 3840]. CNend
   \param[in] u32Height  virtual screen height, the range is [480, 4096].CNcomment:������Ļ�߶ȣ�ȡֵ��ΧΪ[480, 3840]. CNend
   \retval ::HI_SUCCESS  success.CNcomment:�ɹ� CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISPδ��ʼ�� CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:��������Ƿ� CNend
   \see \n
...
/**
   ...
   none. CNcomment: �� CNend
   \param[in] enDisp   DISP channel ID.CNcomment:DISPͨ���� CNend
   \param[out] u32Width  virtual screen width, the range is [480, 4096].CNcomment:������Ļ��ȣ�ȡֵ��ΧΪ[480, 3840]. CNend
   \param[out] u32Height  virtual screen height, the range is [480, 4096].CNcomment:������Ļ�߶ȣ�ȡֵ��ΧΪ[480, 3840]. CNend
   \retval ::HI_SUCCESS  success.CNcomment:�ɹ� CNend
   \retval ::HI_ERR_DISP_NO_INIT    DISP uninitialization.CNcomment:DISPδ��ʼ�� CNend
   \retval ::HI_ERR_DISP_INVALID_PARA   invalid input parameter.CNcomment:��������Ƿ� CNend
   \see \n
