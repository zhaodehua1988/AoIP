...
typedef enum hiUNF_AVPLAY_BUFID_E
{
    ...
    HI_UNF_AVPLAY_BUF_ID_ES_AUD  = 1,    /**<ID of the buffer for storing the audio ESs played by an AVPLAY*//**<CNcommentAV������ES��ƵBuffer ID.*/
...
typedef enum hiUNF_AVPLAY_ATTR_ID_E
{
    ...
    HI_UNF_AVPLAY_ATTR_ID_TVP,              /**<Trusted Video Path Attr, HI_UNF_AVPLAY_TVP_ATTR_S * *//**<CNcomment: ��ȫ��Ƶͨ·���� , HI_UNF_AVPLAY_TRUST_VIDEO_PATH_ATTR_S * .*/
...
/**
\brief Get AVPLAY handle which attach to the window. CNcomment:��ȡ���ָ�����ڵ�AVPLAY��� CNend
\attention \n
\param[out] phAvplay  Pointer to AVPLAY handle. CNcomment: ָ�����ͣ�ָ��AVPLAY�����ָ��. CNend
\param[in] hWindow    window handle . CNcomment:���ھ�� . CNend
\retval ::HI_SUCCESS Success CNcomment:�ɹ� CNend
\retval ::HI_ERR_AVPLAY_NULL_PTR  The pointer is null.  CNcomment:ָ��Ϊ�� CNend
\retval ::HI_FAILURE  Failure, no AVPLAY attached to the window. CNcomment:ʧ��,û��AVPLAY�������. CNend
\see \n
N/A
*/
